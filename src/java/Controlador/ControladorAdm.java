...
public class ControladorAdm extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       Administrador datosUsuario = new Administrador();
       datosUsuario.setUsuario(login);
       datosUsuario.setClave(pass);
       
       AdministradorDAO administradorDAO = new AdministradorDAO();
       Administrador sesion = administradorDAO.validar(datosUsuario);
       HttpSession sesionUsuario = request.getSession();
       Administrador _sesionUsuario = (Administrador)sesionUsuario.getAttribute("usuario");
       if(_sesionUsuario == null){
           ...
           request.setAttribute("Error","verifique su Usuario/Contraseña");
