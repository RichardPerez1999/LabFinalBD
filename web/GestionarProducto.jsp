...
<html lang="en">
  ...
  <body> <!-- Page Preloder -->
      ...
      <div class="container">
        <div class="row">
          ...
          <nav class="main-menu">
            <ul>
              <center>
                <li><a href="ControlVentas.jsp">Control de Ventas</a></li>
    ...
    <div class="page-info-section set-bg" data-setbg="img/page-bg/3.jpg">
      <div class="container">
        <div class="site-breadcrumb"> <a href="indexAdm.html">Inicio</a> <span>Gestionar
            Productos</span> </div>
      </div>
    </div>
    <!-- Page info end -->
          ...
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <form action="ControladorProductos" method="POST"> 
                ...
                <input class="last-m" placeholder="Codigo de Barras" name="CodigodeBarras" type="text"> 
                <br>
                <br>
                <input class="last-m" placeholder="Nombre" name="Nombre" type="text"> 
                <br>
                <br>
                <input class="last-m" placeholder="Cantidad" name="Cantidad" type="text"> 
                <br>
                <br>
                <input class="last-m" placeholder="Precio" name="Precio" type="text">  
                <br>
                <br>
                
                <button class="site-btn btn-dark" name="IngresarProducto">Ingresar Producto</button> 
                <button class="site-btn btn-dark" name="EliminarProducto">Eliminar Producto</button> 
